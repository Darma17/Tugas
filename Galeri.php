    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-tengah">
                <h2><?= $foto[1];?></h2>
                <small><?= $waktu[3];?></small>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[2];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[3];?>" alt="">
                </div>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[4];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[5];?>" alt="">
                </div>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[6];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[7];?>" alt="">
                </div>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[8];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[9];?>" alt="">
                </div>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[10];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[11];?>" alt="">
                </div>
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[12];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[13];?>" alt="">
                </div>           
                <p style="font-weight: bold; text-align: center; margin-bottom:10px; margin-top:30px"><?= $foto[14];?></p>
                <div class="fto">
                    <img src="images/<?= $foto[15];?>" alt="">
                </div> 
                <div class="fto">
                    <img src="images/<?= $foto[16];?>" alt="">
                </div> 
                <div class="fto">
                    <img src="images/<?= $foto[17];?>" alt="">
                </div> 
                <div class="fto">
                    <img src="images/<?= $foto[18];?>" alt="">
                </div> 
                <div class="fto">
                    <img src="images/<?= $foto[19];?>" alt="">
                </div> 
                <div class="fto">
                    <img src="images/<?= $foto[20];?>" alt="">
                </div> 
            </div>
