    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-tengah">
                ...
                <small><?= $waktu[3];?></small>
                <div class="gmb">
                    <img src="images/<?= $perpus[1];?>" alt="">
                </div>
                
                    <h6 class="p1"><?= $perpus[2];?></h6>
                    <h6 class="p2"><?= $perpus[3];?></h6>
                    <h6 class="p3"><?= $perpus[4];?></h6>
                    <h6 class="p4"><?= $perpus[5];?></h6>
                    <h6 class="p5"><?= $perpus[6];?></h6>
                    <h6 class="p6"><?= $perpus[7];?><a href="<?= $perpus[10];?>" target="_blank"><?= $perpus[8];?></a></h6>
