    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-tengah">
                ...
                <p><?= $bas[4];?></p>   
                <p><?= $bas[5];?></p>   
                <p style="color:blue; text-align:center;"><?= $bas[6];?></p>
                <div class="gmb">
                    <img src="images/<?= $bas[2];?>" alt="" width="300px">
                </div>
                <p style="color:blue; text-align:center;"><?= $bas[7];?></p>
                <div class="gmb">
                    <img src="images/<?= $bas[3];?>" alt="" width="300px">
                </div>
            </div>
