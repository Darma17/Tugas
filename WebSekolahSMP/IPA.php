...
<body>
    <div class="container">
        ...
        <ul>
                ...
                <li><a href="Galeri.php"><?= $nav[4];?> <i class="fa-solid fa-angles-right"></i></a>
                    <ul class="bar">
        ...
        <div class="main">
            ...
            <div class="main-tengah">
                ...
                <small><?= $waktu[3];?></small>
                <div class="gmb">
                    <img src="images/<?= $ipa[2];?>" alt="" width="500px">
                </div>
                
                    <h6 class="p1"><?= $ipa[3];?></h6>
                    <h6 class="p2" style="font-weight:bold; color: chocolate; font-size:30px;"><?= $ipa[4];?></h6>
                    <h6 class="p3"><?= $ipa[5];?></h6>
                    <h6 class="p4" style="font-weight:bold; color: chocolate; font-size:30px;"><?= $ipa[6];?></h6>
