        ...
        <div class="main">
            ...
            <div class="main-tengah">
                <div class="main-tengah-1">
                    <img src="images/<?= $gambar[6]?>" alt="" class="slide">
                    <img src="images/<?= $gambar[5]?>" alt="" class="slide">
                    <img src="images/<?= $gambar[0]?>" alt="" class="slide">
                </div>
                <div class="main-tengah-2">
                    <h3><?= $kalimat[0];?></h3>
                    <small><?= $waktu[0]?></small>
                    <div class="inline">
                        <img src="images/<?= $gambarbrt[0];?>" alt="">
                        <p><?= $berita[1];?></p>
                    </div>
                </div>
                ...
                <small><?= $waktu[0]?></small>
                    <div class="inline">
                        <img src="images/<?= $gambarbrt[1];?>" alt="">
                        <p><?= $berita[2];?></p>
                    </div>
                </div>
                ...
                <small><?= $waktu[0]?></small>
                    <div class="inline">
                        <img src="images/<?= $gambarbrt[2];?>" alt="">
                        <p><?= $berita[3];?></p>
                    </div>
                </div>
                ...
                <small><?= $waktu[0]?></small>
                    <div class="inline">
                        <img src="images/<?= $gambarbrt[3];?>" alt="">
                        <p><?= $berita[4];?></p>
                    </div>
                </div>
                ...
                <small><?= $waktu[0]?></small>
                    <div class="inline">
                        <img src="images/<?= $gambarbrt[4];?>" alt="">
                        <p><?= $berita[5];?></p>
                    </div>
                </div>
            </div>
