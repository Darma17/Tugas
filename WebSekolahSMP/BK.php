    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-tengah">
                ...
                <small><?= $waktu[3];?></small>
                <div class="gmb">
                    <img src="images/<?= $bk[2];?>" alt="" width="500px">
                </div>
                
                    <h6 class="p1"><?= $bk[3];?></h6>
                    <h6 class="p2" style="font-weight:bold; color: chocolate; font-size:30px;"><?= $bk[4];?></h6>
                    <h6 class="p3"><?= $bk[5];?></h6>
                    <h6 class="p4" style="font-weight:bold; color: chocolate; font-size:30px;"><?= $bk[6];?></h6>
